...
var BlogRollE2E = (function () {
    ...
    BlogRollE2E.prototype.setBlogTitle = function () {
        ...
        globals_1.element(globals_1.by.xpath('//*/input[@ng-reflect-model="Blue Trane"]')).clear().then(function () {
            globals_1.element(globals_1.by.xpath('//*/input[@ng-reflect-model="Blue Trane"]')).sendKeys('Green Trane');
        });
        globals_1.browser.sleep(2000);
    };
    BlogRollE2E.prototype.pressSaveButton = function () {
    };
    return BlogRollE2E;
}());
exports.BlogRollE2E = BlogRollE2E;
//# sourceMappingURL=/Users/dominique/Documents/Software_Dev/WebDevelopment/AngularJS/angularUnitTest3/ts-node/ee2674c71b18746718d6b3ca1639f9375095346a/cb1d6c403576da64df72aee13fefd74e697d6e88.js.map